...
function addRoute(event)
{
	...
	var carburant = $("#carburant").attr("value");
	var conso = $("#conso").attr("value")/100;
	var car = $("#searchCar").attr("value").slice(0,25);
	console.log(car);
    var obj = doAddRoute(start, end, type, nbPassengers, conso, carburant, transmission, car);
 ...
 */
function doAddRoute(start, end, type, nbPassengers, conso, carburant, transmission, car)
{
